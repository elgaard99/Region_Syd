...
namespace Region_Syd.Model
{
    public class AssignmentRepo : IRepository<Assignment>
    {
        ...
        public void ResetDBToDummyData()
        {
            ...
            string query = @"
-- Drop tables (this automatically removes foreign keys in SQLite)
...
CREATE TABLE IF NOT EXISTS Assignments (
    ...
    Finish TEXT,
    Description TEXT,
    IsMatched INTEGER,  -- Use INTEGER for boolean in SQLite
    AmbulanceID TEXT,
...
-- Insert data into AssignmentTypes
...
-- Insert data into Assignments_Addresses
